...
@allure.step("Launch Swag Labs app")
...
@allure.step("Verify login screen is visible")
...
@allure.step("Login with username '{user_name}' and password '{user_password}'")
...
@allure.step("Verify error message contains '{error_text}'")
